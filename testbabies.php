...
//Functie Uitlezen laasts 2 toegevoegd
$opdrachtlaatstoegevoegd = "SELECT * FROM $tabelkaartjes WHERE Bevestigd = '1' ORDER BY PostID DESC LIMIT 0,1";
$result5 = mysql_query($opdrachtlaatstoegevoegd);
$Rij5 = mysql_fetch_array($result5);

$opdrachtlaatstoegevoegd2 = "SELECT * FROM $tabelkaartjes WHERE Bevestigd = '1' ORDER BY PostID DESC LIMIT 1,1";
$result6 = mysql_query($opdrachtlaatstoegevoegd2);
$Rij6 = mysql_fetch_array($result6);


//Naam
$laatsttoegevoegdbabynaam = "$Rij5[Voornaam] $Rij5[Tussenvoegsel] $Rij5[Achternaam]";
$laatsttoegevoegdbabynaam2 = "$Rij6[Voornaam] $Rij6[Tussenvoegsel] $Rij6[Achternaam]";

//text
$laatsttoegevoegdbabytext = "$Rij5[VrijeTekst]";
$laatsttoegevoegdbabytext2= "$Rij6[VrijeTekst]";

//Geboortedatum
$laatstoegevoegdbabydatum = "$Rij5[Geboortedatum]";
$laatstoegevoegdbabydatum2 = "$Rij6[Geboortedatum]";
...
//Laatste Jongen-------------------------
$opdrachtlaatsjongen = "SELECT * FROM $tabelkaartjes WHERE Bevestigd = '1' AND Geslacht = 'M' ORDER BY Geboortedatum DESC";
...
//Laatste Meisje-------------------------
$opdrachtlaatsmeisje = "SELECT * FROM $tabelkaartjes WHERE Bevestigd = '1' AND Geslacht = 'V' ORDER BY Geboortedatum DESC";
$result4 = mysql_query($opdrachtlaatsmeisje);
$Rij4 = mysql_fetch_array($result4);

//Naam
$laatstgeslachtbabynaammeisje = "$Rij4[Voornaam] $Rij4[Tussenvoegsel] $Rij4[Achternaam]";

//text
$laatstgeslachtbabytextmeisje= "$Rij4[VrijeTekst]";

//Geboortedatum
$laatstgeslachtbabydatummeisje = "$Rij4[Geboortedatum]";
...
<div id="container"> 
  ...
  <div class="kaartjesnummer2">
    <div class="wrapper">
      ...
      <div id="post_header" class="right">
        <p>
        <h1><?php echo $laatsttoegevoegdbabynaam2;?></h1>
        <h2><?php echo $laatsttoegevoegdbabytext2;?></h2>
        <h3><?php echo $laatstoegevoegdbabydatum2;?></h3>
        </p>
        <a href="#" class="button right">Kaartje</a> </div>
      <!-- Einde post_header -->
      ...
      <div id="post_header">
        <p>
        <h1><?php echo $laatsttoegevoegdbabynaam;?></h1>
        <h2><?php echo $laatsttoegevoegdbabytext;?></h2>
        <h3><?php echo $laatstoegevoegdbabydatum;?></h3>
        </p>
        <a href="#" class="button right">Kaartje</a> </div>
      <!-- Einde post_header --> 
  ...
  <div class="kaartjesnummer3">
    <div class="wrapper">
      ...
      <div id="post_header" class="right">
        <p>
        <h1><?php $laatstgeslachtbabynaammeisje?></h1>
        <h2><?php $laatstgeslachtbabytextmeisje?></h2>
        <h3><?php $laatstgeslachtbabydatummeisje?></h3>
        </p>
        <a href="#" class="button right">Kaartje</a> </div>
      <!-- Einde post_header -->
