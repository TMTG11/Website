<?php
	...
	function favicon($type) {
		...
		if($geslacht == "M") {
			return("http://tmtg11.ict-lab.nl/website/img/logo/favicon_blauw.ico");
		} else if($geslacht == "V") {
			return("http://tmtg11.ict-lab.nl/website/img/logo/favicon_roze.ico");
		} else {
			return("http://tmtg11.ict-lab.nl/website/img/logo/favicon.ico");
		}
	}
